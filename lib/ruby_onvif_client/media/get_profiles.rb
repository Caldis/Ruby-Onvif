        ...
        class GetProfiles < Action
            def run cb
                ...
                send_message message do |success, result|
                    reg = /The requested URL was not found on this server/
                    if success && reg.match(result.inspect) == nil
                        ...
                        xml_doc.xpath('//trt:Profiles').each do |root_node|
                            ...
                            success_result[:ipa] = @ipa.to_s unless video_source.nil?
                            profiles << success_result
                        end
                        callback cb, success, profiles
                    elsif success && reg.match(result.inspect) != nil
